...
namespace PLLAT\Dependencies\Monolog;

use Closure;
use DateTimeZone;
use Fiber;
use PLLAT\Dependencies\Monolog\Handler\HandlerInterface;
use PLLAT\Dependencies\Monolog\Processor\ProcessorInterface;
use PLLAT\Dependencies\Psr\Log\LoggerInterface;
use PLLAT\Dependencies\Psr\Log\InvalidArgumentException;
use PLLAT\Dependencies\Psr\Log\LogLevel;
use Throwable;
use Stringable;
use WeakMap;

/**
 * PLLAT\Dependencies\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Debug
     */
     ...
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Info
     */
     ...
     * Uncommon events
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Notice
     */
     ...
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Warning
     */
     ...
     * Runtime errors
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Error
     */
     ...
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Critical
     */
     ...
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Alert
     */
     ...
     * Urgent alert.
     *
     * @deprecated Use \PLLAT\Dependencies\Monolog\Level::Emergency
     */
    public const EMERGENCY = 600;

    /**
     * PLLAT\Dependencies\Monolog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and PLLAT\Dependencies\Monolog ones
     *
     ...
     * there is no performance penalty and PLLAT\Dependencies\Monolog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int                    $level    The logging level (a PLLAT\Dependencies\Monolog or RFC 5424 level)
     ...
     *
     * @throws \PLLAT\Dependencies\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  value-of<Level::VALUES>|Level $level
     * @phpstan-return value-of<Level::NAMES>
     *
     * @deprecated Since 3.0, use {@see toMonologLevel} or {@see \PLLAT\Dependencies\Monolog\Level->getName()} instead
     */
    ...
    /**
     * Converts PSR-3 levels to PLLAT\Dependencies\Monolog ones if necessary
     *
