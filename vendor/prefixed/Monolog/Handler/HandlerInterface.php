...
namespace PLLAT\Dependencies\Monolog\Handler;

use PLLAT\Dependencies\Monolog\LogRecord;

/**
 * Interface that all PLLAT\Dependencies\Monolog Handlers must implement
 *
...
interface HandlerInterface
{
     ...
     * is destroyed if you extend PLLAT\Dependencies\Monolog\Handler\Handler.
     *
